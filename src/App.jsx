    ...
    <LoadingProvider>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/kpr" element={<ProtectedRoute><KprPage /></ProtectedRoute>} />
          ...
          <Route path="/beli" element={<ProtectedRoute> <Beli /> </ProtectedRoute>} />
          <Route path="/detailrumah/:refid" element={<ProtectedRoute> <HalamanDetail /> </ProtectedRoute>} />
        </Routes>
      </BrowserRouter>
    </LoadingProvider>
  );
